...
<style>
  ...
  <div class="max-w-7xl mx-auto p-6">
    ...
    <div id="tab-constraints" class="settings-tab-content hidden p-6">
      <h3 class="text-xl font-bold text-slate-900 mb-1">Constraints & Rules</h3>
      ...
      <!-- Load Balancing -->
      <div class="border rounded-lg p-4 bg-white mb-4">
        <h4 class="font-semibold mb-4 text-slate-800">Load Balancing Framework</h4>
          ...
          <div class="section-content border-t border-slate-200 bg-white transition-all overflow-hidden" style="max-height: 0px; padding: 0; border: none;">
            <div class="space-y-3 p-4">
              ...
              <div class="p-3 bg-slate-100 rounded border border-slate-300 mt-3">
                <div class="text-xs font-semibold text-slate-800 mb-2">Algorithm Factors (if weighted):</div>
          ...
          <div class="section-content border-t border-slate-200 bg-white transition-all overflow-hidden" style="max-height: 0px; padding: 0; border: none;">
            <div class="space-y-3 p-4">
              ...
              <div class="p-3 border-2 border-amber-300 bg-amber-50 rounded-lg">
                <div class="font-semibold text-sm text-amber-900 mb-2">Load Balancing Warnings</div>
                <div class="space-y-2">
      ...
      <!-- Advanced Settings -->
      <div class="border rounded-lg p-4 bg-white mb-4">
        <h4 class="font-semibold mb-3 text-slate-800">Advanced Settings</h4>
        <div class="grid grid-cols-2 gap-4">
          <div>
