        ...
        <div id="panel-subjects" class="hidden bg-white border rounded p-4" role="tabpanel" aria-labelledby="tab-subjects">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-slate-50" data-subject-id="<?php echo e($subj->id); ?>" data-grade-ids="<?php echo e($subj->gradeLevels->pluck('id')->join(',')); ?>" data-strand-id="<?php echo e($subj->strand_id ?? ''); ?>" data-type="<?php echo e($subj->type); ?>">
                                ...
                                <td class="px-4 py-3 text-sm text-slate-600">
                                    <?php if($subj->hours_per_week !== null): ?>
                                        <?php
                                            $hours = floor($subj->hours_per_week);
                                            $minutes = round(($subj->hours_per_week - $hours) * 60);
                                        ?>
                                        <?php if($hours > 0): ?>
                                            <?php echo e($hours); ?> hr<?php echo e($hours > 1 ? 's' : ''); ?>

                                        <?php endif; ?>
                                        <?php if($minutes > 0): ?>
                                            <?php echo e($hours > 0 ? ' ' : ''); ?><?php echo e($minutes); ?> min<?php echo e($minutes > 1 ? 's' : ''); ?>
                                ...
                                <td class="px-4 py-3 text-sm">
                                    <button type="button" class="text-blue-600 hover:text-blue-800 mr-2 btn-edit-subject" 
                                        data-id="<?php echo e($subj->id); ?>"
                                        data-name="<?php echo e($subj->name); ?>"
                                        data-code="<?php echo e($subj->code); ?>"
                                        data-type="<?php echo e($subj->type); ?>"
                                        data-hours="<?php echo e($subj->hours_per_week); ?>"
                                        >Edit</button>
            ...
            <div id="subject-modal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50" style="align-items: center; justify-content: center;">
                <div class="bg-white rounded-lg shadow-xl w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto">
                    ...
                    <form id="subject-form" class="px-6 py-4" method="POST" action="<?php echo e(route('admin.subjects.store')); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        document.addEventListener('DOMContentLoaded', function() {
                            ...
                            if(form) {
                                form.setAttribute('action', '<?php echo e(route('admin.subjects.store')); ?>');
