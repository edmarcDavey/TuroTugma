    ...
    <div class="max-w-4xl mx-auto px-6 py-8">
      ...
      <main class="mt-8">
        <div class="p-6 border rounded-lg">
          ...
          <p class="mt-2 text-sm text-slate-600">You are signed in as the Admin (ID: <?php echo e(auth()->user()->email); ?>).</p>
...
<?php /**PATH C:\xampp\htdocs\TuroTugma\resources\views\dashboard_it.blade.php ENDPATH**/ ?>