...
<html lang="en">
  <head>
    ...
    <title>IT Coordinator Dashboard</title>
    @vite(['resources/css/app.css', 'resources/js/app.js'])
  </head>
  <body class="bg-white text-slate-800 min-h-screen">
    <div class="max-w-4xl mx-auto px-6 py-8">
      <header class="flex items-center justify-between">
        <h1 class="text-2xl font-semibold">IT Coordinator Dashboard</h1>
      ...
      <main class="mt-8">
        <div class="p-6 border rounded-lg">
          ...
          <p class="mt-2 text-sm text-slate-600">You are signed in as the IT Coordinator (ID: {{ auth()->user()->email }}).</p>
