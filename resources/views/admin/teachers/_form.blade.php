...
<form id="teacher-form" method="POST" action="{{ $action }}">
  ...
  <div>
    ...
    <input id="phone" name="phone" required value="{{ old('phone', $teacher->phone ?? '') }}" class="mt-1 block w-full border border-gray-300 rounded-md p-2 h-11 bg-white box-border" />
  </div>
    </div>
