<?php
// tools/delete_seeded_teachers.php
// Bootstraps Laravel and deletes seeded teachers created earlier by the Filipino seeder.
...
// Criteria: staff_id starts with 'T' and email contains '@example.edu.ph'
$teachers = Teacher::where('staff_id', 'like', 'T%')
    ->where('email', 'like', '%@example.edu.ph')
    ->get();

if ($teachers->isEmpty()) {
    echo "No matching seeded teachers found (staff_id like 'T%' and email @example.edu.ph).\n";
    exit(0);
}
